...
from accounts.decorators import specialist_required, teacher_required
...
# @method_decorator([login_required, specialist_required], name='get_queryset')
    ...
    def get_queryset(self):
        if self.request.user.is_superuser:
            ...
            queryset = (
                ...
                .get_queryset()
                .filter(
                    quiz__course__allocated_course__specialist__pk=self.request.user.id
                )
...
class QuizTake(FormView):
    ...
    def final_result_user(self):
        ...
        if (
            ...
            or self.request.user.is_specialist
        ):
            self.sitting.delete()
